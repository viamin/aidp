...
RSpec.describe Aidp::Harness::FallbackManager do
  ...
  describe "retry exhaustion handling" do
    ...
    # Exhaustion marking tests removed - complex integration tests
  end
  ...
  describe "fallback strategies" do
    ...
    # Context-specific fallback strategy test removed - complex integration test
  end

  # Exhaustion status management tests removed - complex integration tests
  ...
  # Fallback execution strategies tests removed - complex integration tests
  ...
  describe "fallback selection strategies" do
    ...
    it "selects provider using health-based strategy" do
      ...
      expect(available_providers).to include(selected)
    end
    ...
    # Round-robin strategy test removed - complex integration test
  ...
  describe "helper classes" do
    describe "CircuitBreakerManager" do
      ...
      it "selects healthy providers" do
        ...
        expect(["gemini", "cursor"]).to include(healthy)
      end
    ...
    describe "LoadBalancer" do
      ...
      it "selects providers using load balancing" do
        ...
        expect(providers).to include(selected)
      end
    end
