...
RSpec.describe Aidp::Config do
  describe ".load" do
    ...
    it "loads config from file when it exists" do
      ...
      expect(Aidp::Config.load).to eq(config_content)
    end
  end
  ...
  describe ".templates_root" do
    it "returns correct templates path" do
      ...
      expect(Aidp::Config.templates_root).to eq(expected_path)
    end
  end
  ...
  describe ".analyze_templates_root" do
    it "returns correct analyze templates path" do
      ...
      expect(Aidp::Config.analyze_templates_root).to eq(expected_path)
    end
  end
  ...
  describe ".execute_templates_root" do
    it "returns correct execute templates path" do
      ...
      expect(Aidp::Config.execute_templates_root).to eq(expected_path)
    end
  end
  ...
  describe ".common_templates_root" do
    it "returns correct common templates path" do
      ...
      expect(Aidp::Config.common_templates_root).to eq(expected_path)
    end
  end
end
