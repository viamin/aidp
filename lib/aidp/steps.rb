...
module Aidp
  class Steps
    ...
    SPEC = {
      ...
      'tasks' => { templates: ['08_TASKS.md'], outs: ['tasks/backlog.yaml'] },
      'scaffold' => { templates: ['09_SCAFFOLDING_DEVEX.md'], outs: ['docs/ScaffoldingGuide.md'] },
      'impl' => { templates: ['10_IMPLEMENTATION_AGENT.md'], outs: ['docs/ImplementationGuide.md'] },
